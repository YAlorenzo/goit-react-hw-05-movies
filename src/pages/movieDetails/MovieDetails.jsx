    ...
    return (
        <div>
            ...
            <div className={css.container}>
                ...
                <nav className={css.nuv_cast_rev}>
                <NavLink to="Cast" className={css.cast_rev}>Click to watch Cast</NavLink>
                <NavLink to="Reviews" className={css.cast_rev}>Click to watch Reviews</NavLink>
                </nav>
